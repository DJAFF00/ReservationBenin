    ...
    <header className="glass sticky top-0 z-50 border-b border-border/60">
      <div className="relative mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Actions visibles uniquement à partir du format tablette */}
          <div className="hidden items-center gap-3 md:flex">
            {user ? (
              ...
              <>
                ...
                <Link
                  href="/inscription"
                  className="rounded bg-ochre px-4 py-2 text-sm font-medium text-ochre-foreground shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_20px_hsl(var(--ochre)/0.4)]"
                >
                  Créer un compte
                </Link>
              </>
          ...
          {/* Menu hamburger, uniquement sous le format tablette */}
          <MobileNav
            isLoggedIn={!!user}
            isAdmin={isAdmin}
